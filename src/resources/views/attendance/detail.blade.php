        ...
        <form action="{{ route('attendance.update', $attendance->id) }}" method="POST">
            ...
            <table class="detail-table">
                ...
                <tr>
                    ...
                    <td class="edit-field-row">
                        <input type="time" name="rests[{{ $attendance->rests->count() }}][break_start]" value="">
                        〜
                        <input type="time" name="rests[{{ $attendance->rests->count() }}][break_end]" value="">
                    </td>
                </tr>
                @else
                {{-- 休憩なしの場合 --}}
